      ...
      var w = (function () {
        ...
        return (
          c()(e, [
              ...
              value: function (e) {
                ...
                if (i && i !== this.previousHtmlCode) {
                  ...
                  this.cssCodeEditor
                    ...
                    (i += "<style>".concat(s, "</style>")),
                    !n || "wrapper" === n.attributes.type
                      ? (t.setComponents(i), (r = t.getWrapper()))
                      : ((r = n.replaceWith(i)), t.select(r)),
                    this.runAppliedHtmlScripts(r);
                }
              },
            },
            {
            ...
            {
              key: "runAppliedHtmlScripts",
              value: function (e) {
                var t = this,
                  n = this.editor,
                  i = n.Canvas && n.Canvas.getWindow ? n.Canvas.getWindow() : null;
                if (i)
                  setTimeout(function () {
                    t.getScriptElementsFromComponents(e).forEach(function (e) {
                      if (!e || e.src) return;
                      var t = (e.textContent || e.innerHTML || "").trim();
                      if (!t) return;
                      try {
                        i.eval("(function(){\n".concat(t, "\n})();"));
                      } catch (t) {
                        console.error("Failed to run applied HTML script", t, e);
                      }
                    });
                  }, 0);
              },
            ...
            {
              key: "getScriptElementsFromComponents",
              value: function (e) {
                var t = [];
                return (
                  this.collectAppliedComponents(e).forEach(function (e) {
                    var n = e && e.getEl ? e.getEl() : null;
                    n &&
                      ("SCRIPT" === n.tagName
                        ? t.push(n)
                        : n.querySelectorAll &&
                          t.push.apply(t, n.querySelectorAll("script")));
                  }),
                  t
                );
              },
            ...
            {
              key: "collectAppliedComponents",
              value: function (e) {
                var t = [];
                return (
                  (function n(i) {
                    if (i)
                      if (Array.isArray(i)) i.forEach(n);
                      else if ("number" == typeof i.length && i.at)
                        for (var r = 0; r < i.length; r++) n(i.at(r));
                      else t.push(i);
                  })(e),
                  t
                );
              ...
              value: function () {
                this.isShowing &&
                  ((this.component = this.editor.getSelected()),
                    this.component &&
                    (function (e, t) {
                      var n = e.getComponentHtml(e.component),
                        i = e.editor.CodeManager.getCode(e.component, "css", {
                          cssc: e.editor.Css,
                        });
                      e.htmlCodeEditor.setContent(n),
                        e.cssCodeEditor.setContent(i),
                        (e.previousHtmlCode = n.trim()),
                        (e.previousCssCode = i.trim());
                    })(this));
              },
            },
            {
                ...
                var t = this.opts,
                  ...
                  i =
                    "wrapper" === e.attributes.type
                      ...
                      : e.toHTML();
                n += i;
                var r = t.editJs ? e.getScriptString() : "";
                return (n += r ? "<script>".concat(r, "</script>") : "");
              },
            },
          ]),
          e
